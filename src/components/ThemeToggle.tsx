    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button 
          variant="ghost" 
          size="icon" 
          className="relative h-9 w-9 rounded-full overflow-hidden focus-ring
                    bg-white/5 dark:bg-gray-800/40 backdrop-blur-md 
                    hover:bg-white/10 dark:hover:bg-gray-700/50 
                    border border-white/10 dark:border-gray-700/60
                    shadow-md hover:shadow-lg
                    transition-all duration-300"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-primary/20 dark:from-primary/10 dark:to-primary/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-full"></div>
      ...
      <AnimatePresence>
        <DropdownMenuContent 
          align="end"
          className="p-2 min-w-[180px] rounded-xl border border-gray-200/30 dark:border-gray-800/30
